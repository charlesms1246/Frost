...
- Allowed origins differ by build:
  - dev (`debug_assertions`): `http://localhost:3000`, `https://xfrost.vercel.app`
  - release: `https://xfrost.vercel.app` only
...
| `https://xfrost.vercel.app` | dev     | 204 + `Allow-Origin: https://xfrost.vercel.app` | not exercised — production bridge isn't being used in dev                                              |
| `https://xfrost.vercel.app` | release | 204 + same                                      | owed at release-bundle smoke (post-Day-1)                                                              |
